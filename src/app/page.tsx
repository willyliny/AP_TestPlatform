...
import { TdChapter1Questions } from './data/questions/TdChapter1';
...
const chapters: { [key: string]: QuizQuestion[] } = {
  'TdChapter1': TdChapter1Questions,
...
const getChapterName = (chapter: string): string => {
  const names: { [key: string]: string } = {
    'TdChapter1': 'CH1 : Primitive Types',
...
export default function QuizPage() {
  const [currentChapter, setCurrentChapter] = useState<string>('TdChapter1');
